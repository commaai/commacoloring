...
define(["./util"], function (util) {
  function Pagination(count, params) {
    ...
    this.render = function (options) {
      ...
      var index = [];
      for (i = 0; i < pages; ++i) {
        if (i <= (page <= neighbors ? 2 : 1) * neighbors || page - neighbors <= i && i <= page + neighbors || pages - (page >= pages - neighbors - 1 ? 2 : 1) * neighbors <= i) index.push(i);
      }
      var container = document.createElement(options.nodeType || "p");
      {
        anchor = document.createElement("a");
        if (page > 0) anchor.href = util.makeQueryParams(params, { page: page - 1 });
      ...
      for (i = 0; i < index.length; ++i) {
        anchor = document.createElement("a");
        if (index[i] !== page) anchor.href = util.makeQueryParams(params, { page: index[i] });
      ...
      {
        anchor = document.createElement("a");
        if (page < pages - 1) anchor.href = util.makeQueryParams(params, { page: page + 1 });
