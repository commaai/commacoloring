...
define(function () {
  ...
  function Layer(source, options) {
    ...
    if (source) {
      if (typeof source === "string" || (typeof source === "undefined" ? "undefined" : _typeof(source)) === "object" && source.nodeName === "IMG") this.load(source, options);else if ((typeof source === "undefined" ? "undefined" : _typeof(source)) === "object" && (source.nodeName === "CANVAS" || source instanceof ImageData)) this.fromCanvas(source, options);
    }
  }
  ...
  Layer.prototype.fromCanvas = function (source, options) {
    ...
    var context = this.canvas.getContext("2d");
    this._setImageSmoothing(context, options);
    if (source instanceof ImageData) context.putImageData(source, 0, 0);else context.drawImage(source, 0, 0, this.canvas.width, this.canvas.height);
    this.imageData = context.getImageData(0, 0, this.canvas.width, this.canvas.height);
    if (typeof options.onload === "function") options.onload.call(this);
    return this;
  };
